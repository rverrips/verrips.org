...
<head>
    ...
    <meta name="DC.subject" content="verrips, christian, family, roy, angela, dubai, doha, chicago, illinois, naperville, hyatt">
    ...
    <script>
        (function(h,o,t,j,a,r){
            ...
            h._hjSettings={hjid:92319,hjsv:5};
            ...
            <div id="container">
                    ...
                    <div class="page_content">
                        <div class="gf-slider">
                            ...
                            <ul class="slides">
                                ...
                                <li> <img src="./docs/images/verrips-2006.png" alt="Angela, Luke, Nathan and Roy Verrips - Dubai 2006" />
                                    <p class="flex-caption"> Angela, Luke, Nathan and Roy Verrips - Dubai 2006</p>
                                </li>
                                <li> <img src="./docs/images/verrips-2008.png" alt="Angela, Luke, Nathan and Roy Verrips - Dubai 2008" />
                                    <p class="flex-caption"> Angela, Luke, Nathan and Roy Verrips - Dubai 2008</p>
                                </li>
                                <li> <img src="./docs/images/verrips-2009.png" alt="Roy, Angela, Nathan and Luke Verrips - Dubai 2009" />
                                    <p class="flex-caption"> Roy, Angela, Nathan and Luke Verrips - Dubai 2009</p>
                                </li>
                                <li> <img src="./docs/images/verrips-2010.png" alt="Nathan, Angela, Luke and Roy Verrips - Dubai 2010" />
                                    <p class="flex-caption"> Nathan, Angela, Luke and Roy Verrips - Dubai 2010</p>
                                </li>
                                <li> <img src="./docs/images/verrips-2012.png" alt="Nathan, Roy, Angela and Luke Verrips - Abu Dhabi 2012" />
                ...
                <div class="page" id="angela">
                    ...
                    <div class="page_content">
                        ...
                        <div class="clear"> </div>
                        <ul class="grid">
                            <li class="norwex"><a target="_blank" href="https://angelaverrips.norwex.biz"> <img src="./docs/images/links/norwex.png" alt="Norwex"></a></li>
                            <li class="norwex"><a target="_blank" href="https://angelaverrips.norwex.biz"> <img src="./docs/images/links/norwex-logo.png" alt="Norwex"></a></li>
                            <li class="facebook"><a target="_blank" href="https://www.facebook.com/averrips/"> <img src="./docs/images/links/Facebook.png" alt="Facebook"></a></li>
                        </ul>
                        <div class="clear"> </div>
                    </div>
                </div>
                    ...
                    <div class="page_content">
                        <p><img src="./docs/images/nathan-2020-300x300.png" class="left no_border" alt="Nathan Verrips" style="margin-top: 0px; margin-right: 0px" height="80px" width="80px"><strong>Nathan</strong> is twenty, and loves board games, reading and programming things.  Nathan is currently a student at <a href="https://cod.edu">College of DuPage</a> pursuing an Associates Degree in Science which, by God's grace, is the first step on his path into optometry/ophthalmology.  He also keeps busy editing and updating a number of Christian websites linked below:<p>
                            ...
                            <div class="page" id="rachel">
                                ...
                                <div class="page_content">
                                    <p><img src="./docs/images/rachel-80x80.png" class="left no_border" alt="Rachel Verrips" style="margin-top: 0px; margin-right: 0px" ><strong>Rachel</strong> was born in March 2004 with CMV (i.e. Cytomegalo Virus) – She had chronic hepatitides and severe jaundice from birth that eventually lead to complete liver failure, and she went to be with our Lord in November 2004.<br>Her constant smile touched everyone it fell upon and we are honoured that God shared her with us and made her part of our family, even for such a short time.</p>
                                </div>
                            </div>
                            ...
                            <!-- page map or Find Us
                                ...
                                <div class="page" id="gospel">
                                    ...
                                    <div class="page_content">
                                        <p>We are a Christian (Evangelical/Reformed/Protestant) family who believe the <strong>Bible</strong> to be God's true word. The below 7-minute video is a brief summary and explaination of "What a Christian is" and "What it is Christians Believe".<br></p>
                                        <h4 class="blue"> What is a Christian?</h4>
                                        <div class="js-video">
                                            <iframe width="560" height="315" src="https://www.youtube.com/embed/kbcvuu8lCFg?origin=https://verrips.org" allowfullscreen></iframe>
                                        </div>
